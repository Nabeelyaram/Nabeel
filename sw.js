const CACHE = "maqsood-karyana-v15";
...
const ASSETS = ["./", "./index.html", "./styles.css", "./app.js", "./config.js", "./manifest.webmanifest", "./app-icon-192.png", "./app-icon-512.png", "./grocery-quick-items-v12.jpg", "./grocery-core-items-v12.png", "./grocery-household-items-v13.png", ...IMAGE_ASSETS];
